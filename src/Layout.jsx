...
const Layout = () => {
  return (
    <div><ul className="flex text-xs shadow-xs sm:shadow-lg sm:w-5/6 mr-2 pl-5 sm:pl-0 sm:ml-24 sm:ml-20 bg-secondary-100 rounded-full p-2 mt-3 sm:justify-center font-bold gap-5 sm:gap-20">
